...
<div class="row">
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
              <span class="info-box-icon bg-gradient-navy elevation-1"><i class="fas fa-th-list style="color: #ffffff"></i></span>
          ...
          <div class="col-12 col-sm-4 col-md-4">
          <div class="info-box">
          <span class="info-box-icon bg-gradient-navy elevation-1"><i class="fas fa-shopping-basket" style="color: #ffffff;"></i></span>
           <div class="info-box-content">
          ...
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
            <span class="info-box-icon bg-gradient-navy elevation-1"><i class="fas fa-money-bill"></i></span>
              <div class="info-box-content">
